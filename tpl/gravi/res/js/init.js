...
(function($) {
	...
	skel.init({
		reset: 'full',
		breakpoints: {
			'global':	{ range: '*', href: 'tpl/gravi/res/css/style.css', containers: 1400, grid: { gutters: 48 } },
			'wide':		{ range: '-1680', href: 'tpl/gravi/res/css/style-wide.css', containers: 1200 },
			'normal':	{ range: '-1280', href: 'tpl/gravi/res/css/style-normal.css', containers: '100%', grid: { gutters: 36 } },
			'narrow':	{ range: '-960', href: 'tpl/gravi/res/css/style-narrow.css', grid: { gutters: 32 } },
			'narrower': { range: '-840', href: 'tpl/gravi/res/css/style-narrower.css', containers: '100%!', grid: { collapse: true } },
			'mobile':	{ range: '-736', href: 'tpl/gravi/res/css/style-mobile.css', grid: { gutters: 20 }, viewport: { scalable: false } }
		},
		plugins: {
			layers: {
				config: {
